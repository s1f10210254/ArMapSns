"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[661],{105:function(e,t,r){r.d(t,{I:function(){return connectAuthEmulator},a8:function(){return createUserWithEmailAndPassword},a9:function(){return signInWithEmailAndPassword},o:function(){return getAuth}});var i,n=r(4444),s=r(5816),a=r(7582),o=r(3333),l=r(8463);function _prodErrorMap(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let c=new n.LL("auth","Firebase",_prodErrorMap()),u=new o.Yd("@firebase/auth");function _logError(e,...t){u.logLevel<=o.in.ERROR&&u.error(`Auth (${s.Jn}): ${e}`,...t)}/**
 * @license
